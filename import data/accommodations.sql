-- ============================================
-- Import des données d'hébergements
-- ============================================

DROP TABLE IF EXISTS public.accommodation_reservations CASCADE;
...
-- Index
CREATE INDEX IF NOT EXISTS idx_accommodations_partner_id ON accommodations(partner_id);
CREATE INDEX IF NOT EXISTS idx_accommodations_weight ON accommodations(weight);
CREATE INDEX IF NOT EXISTS idx_accommodations_type ON accommodations(type);

-- Activer RLS
ALTER TABLE public.accommodations ENABLE ROW LEVEL SECURITY;

-- Politique de lecture publique des hébergements
